...
${PROJECT_DIR}/build/bin/$Bin_NAME --bootnodes "enode://cbac8dee6adc4dc6b68bbb5c84e4810a4ca1f517622306d21decf72c0c4de6b0b7f07ba4ab333a75f34b0f0b9b852c8b7f5f56bd6aa06a3170a096a48958d2ed@127.0.1.1:30301" --syncmode "full" --datadir ./nodes/1 --networkid 13123 --port 30303 --rpc --rpccorsdomain "*" --ws --wsaddr="0.0.0.0" --wsorigins "*" --wsport 8555 --rpcaddr 0.0.0.0 --rpcport 8545 --rpcvhosts "*" --unlock "${wallet1}" --password ./.pwd --mine --gasprice "${GASPRICE}" --targetgaslimit "420000000" --verbosity ${VERBOSITY} --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,XDPoS --ethstats "KMZXinFin-KMSMasterNode-01:xinfin_test_network_stats@stats_testnet.xinfin.network:3000"
